...
macro(50, "Utamo Vita 2",function()
if not hasManaShield() then
say("Utamo Vita") 
end
end)
...
local singleTargetSpell = 'exori flam'
local multiTargetSpell = 'exevo gran mas peste'
local distance = 3
...
addTextEdit("Spell1", storage.Spell1 or "Exori Flam", function(widget, text) 
storage.Spell1 = text
end)
addTextEdit("Spell2", storage.Spell2 or "Exevo Gran Mas Peste", function(widget, text) 
storage.Spell2 = text
end)
...
macro(5000,"Resetter",function()
 use(10302)
end)

macro(7000,"USE Hourglas",function()
 use(9660)
end)
...
macro(4000,"Mas Peste - Spot 7",function()
if g_game.isAttacking() then say("exevo gran mas peste") end
end)
