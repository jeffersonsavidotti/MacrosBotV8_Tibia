...
macro(2500,"Utito Tempo San",function()
local skillatual = 160
local skillutito = 46
  if player:getSkillLevel(4)>=100 and not isInPz() then
  say("Utito Tempo San")
  end
end)
...
local multiTargetSpell = 'exevo holy san'
local distance = 3
...
macro(4000,"Holy San - Spot 7",function()
if g_game.isAttacking() then say("exevo holy san") end
end)
